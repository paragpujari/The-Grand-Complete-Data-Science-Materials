...
#### Load the Model
sc      = joblib.load("Standard_SVC.pickle")
...
st.write("Predict whether the person is having diabetes or not based on the diabetes condition using  Support Vector Classifier")
...
if(st.button("Predict Diabetes")):
    ...
    #### predict the model
    predictions = svc.predict(scale_input_data)[0]

    probability = svc.predict_proba(scale_input_data)[0][1]
