...
#### Load the Model
sc = joblib.load("StandardNB.pickle")
gnb = joblib.load("GaussianNaiveBayes.pickle")
...
#### Predict whether the patient is sufering from diabetes or not
if(st.button("Predict diabetes")):
    ...
    #### Predict the model
    predictions = gnb.predict(scaled_input)[0]
    probability = gnb.predict_proba(scaled_input)[0][1]
