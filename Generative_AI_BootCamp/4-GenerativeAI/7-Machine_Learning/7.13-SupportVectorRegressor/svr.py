...
#### Load the Model
sc     = joblib.load("Standard_svr.pickle")
svr    = joblib.load("Support_Vector_Regressor.pickle")
...
st.write("Predict the House Price based on the Housing features using Support Vector Regressor")
...
if(st.button("Predict Housing Price")):
    ...
    predictions = svr.predict(scaled_input)
